                 ...
                 children: [
                   Container(
                                 ...
                                 child: Column(children: [
                                  ...
                                  Text("PLAY NEW THEMES",
                                                             style:GoogleFonts.bangers
                                                             (fontStyle:FontStyle.normal,letterSpacing:
                                                              width*0.005,fontSize: width*0.025, color: Colors.white),),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("SELECT GAME",
                          style:GoogleFonts.bangers
                                      (fontStyle:FontStyle.normal,letterSpacing:
                      width*0.005,fontSize: width*0.08, color: Colors.amber,)),
                      SizedBox(width: width*0.1,),
                            Container(
                  height: height*0.04,
                  width: width*0.07,
         child: Icon(Icons.question_mark,     color: const Color(0xFFFFB300),size: width*0.05,),
                     decoration: BoxDecoration(
               ...
               Container(
                ...
                child: Row(children: [
                  ...
                  CircleAvatar(
                    radius: width*0.01,
                    backgroundColor: const Color.fromARGB(255, 12, 207, 19),
                  ),
