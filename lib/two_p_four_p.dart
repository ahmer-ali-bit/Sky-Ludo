...
class TwoPFourP extends StatefulWidget {
  const TwoPFourP({super.key});

  @override
  State<TwoPFourP> createState() => _SelectColorState();
}

class _SelectColorState extends State<TwoPFourP> {
  bool isOn = true;
           late double height;
late double width;
                ...
                spreadRadius: 1,
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                           child: Text("SELECT YOUR COLOR",
                  style:GoogleFonts.bangers
                  (fontStyle:FontStyle.normal,letterSpacing:
                   width*0.005,fontSize: width*0.07, color: Colors.cyan),),
                          ),
                          Container(
                            height: height * 0.06,
                            width: width * 0.6,
                                        ...
                                        100,
                                            ...
                                            width: 1,
                                                         ...
                                                         activeColor: Colors.green,
                                                                          checkColor: Colors.white,                  value: selectedIndex == 0,
                                          onChanged: (value) {
                                            setState(() {
                                              selectedIndex = 0;
                                            });
                                          ...
                                          Transform.scale(
                                            ...
                                            child: Checkbox(
                                                ...
                                                width: 1,
                                                             ...
                                                             activeColor: Colors.green,
                                                                              checkColor: Colors.white,                     value: selectedIndex == 1,
                                              onChanged: (value) {
                                                setState(() {
                                                  selectedIndex = 1;
                                                });
                                       ...
                                       child: Checkbox(
                                        ...
                                        100,
                                           ...
                                           width: 1,
                                               ...
                                               activeColor: Colors.green,
                                                                         checkColor: Colors.white,                            value: selectedIndex == 3,
                                         onChanged: (value) {
                                  ...
                                  width: width*0.18,
                                         ...
                                         child: Center(
                                           child: Text("2P",
                                                             style:GoogleFonts.bangers
                                                             (fontStyle:FontStyle.normal,letterSpacing:
                                                              width*0.005,fontSize: width*0.07, color: Colors.white),),
                                         ),
                                 decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(width*0.03),
                        gradient: const LinearGradient(
  ...
  child: Row(
    ...
    children: [
      ...
      Text("5P/6P :",
                                                             style:GoogleFonts.bangers
                                                             (fontStyle:FontStyle.normal,letterSpacing:
                                                              width*0.005,fontSize: width*0.045, color: Colors.white),),
Transform.scale(
  scale: 0.35,
  child: Container(
    width: width*0.08,
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          height: height*0.02,
                          width: width*0.043,
child: Center(child: Icon(Icons.remove,color: Colors.white,size: width*0.035,)),
decoration: BoxDecoration(
color: Colors.green,
...
Text("1000 COINS",
                        style:GoogleFonts.bangers
                        (fontStyle:FontStyle.normal,letterSpacing:
                        width*0.005,fontSize: width*0.03, color: Colors.white),),
                                             Container(
                          height: height*0.02,
                          width: width*0.043,
child: Center(child: Icon(Icons.add,color: Colors.white,size: width*0.035,)),
decoration: BoxDecoration(
color: Colors.green,
borderRadius: BorderRadius.circular(width*0.009)
)
